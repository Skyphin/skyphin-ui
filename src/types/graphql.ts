...
export const useAddCommentMutation = <
    ...
    mutationFn: (variables?: AddCommentMutationVariables) => fetcher<AddCommentMutation, AddCommentMutationVariables>(dataSource.endpoint, dataSource.fetchParams || {}, AddCommentDocument, variables)(),
    ...options
  }
    )};
...
export const useAddReplyMutation = <
    ...
    mutationFn: (variables?: AddReplyMutationVariables) => fetcher<AddReplyMutation, AddReplyMutationVariables>(dataSource.endpoint, dataSource.fetchParams || {}, AddReplyDocument, variables)(),
    ...options
  }
    )};
...
export const useDownvoteCommentMutation = <
    ...
    mutationFn: (variables?: DownvoteCommentMutationVariables) => fetcher<DownvoteCommentMutation, DownvoteCommentMutationVariables>(dataSource.endpoint, dataSource.fetchParams || {}, DownvoteCommentDocument, variables)(),
    ...options
  }
    )};
...
export const useUpvoteCommentMutation = <
    ...
    mutationFn: (variables?: UpvoteCommentMutationVariables) => fetcher<UpvoteCommentMutation, UpvoteCommentMutationVariables>(dataSource.endpoint, dataSource.fetchParams || {}, UpvoteCommentDocument, variables)(),
    ...options
  }
    )};
...
export const useGetCommentThreadQuery = <
    ...
    queryFn: fetcher<GetCommentThreadQuery, GetCommentThreadQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, GetCommentThreadDocument, variables),
    ...options
  }
    )};
...
export const useGetCommentsCountQuery = <
    ...
    queryFn: fetcher<GetCommentsCountQuery, GetCommentsCountQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, GetCommentsCountDocument, variables),
    ...options
  }
    )};
...
export const useGetVotesQuery = <
    ...
    queryFn: fetcher<GetVotesQuery, GetVotesQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, GetVotesDocument, variables),
    ...options
  }
    )};
